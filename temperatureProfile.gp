...
set   ylabel    "{/:Italic T}" offset 1.5,0.0,0.0
set format x "%.3f"
...
set   output   "temperature_profiles.svg"
unset key
set   key on
...
file1="postProcessing/temperatureProfile/".myStep."/line.xy"
file2="postProcessing/temperatureProfileInlet/".myStep."/line.xy"
file3="postProcessing/temperatureProfileOutlet/".myStep."/line.xy"

plot  file1  using 1:2 every 1 title "fully"     with lines dashtype 1 linewidth 2 linecolor rgbcolor "black", \
      file2  using 1:2 every 1 title "inlet"     with points pointtype 7 pointsize 0.4 linecolor rgbcolor "black", \
      file3  using 1:2 every 1 title "outlet"    with points pointtype 2 pointsize 0.5 linecolor rgbcolor "black"

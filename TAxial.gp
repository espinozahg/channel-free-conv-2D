...
plot  file1  using 1:6 every 1 title "mesh10"     with points pointtype 7 pointsize 0.4 linecolor rgbcolor "black"

#plot  file1  using 1:6 every 1 title "fully"     with lines dashtype 1 linewidth 2 linecolor rgbcolor "black", \
#      file2  using 1:6 every 1 title "inlet"     with points pointtype 7 pointsize 0.4 linecolor rgbcolor "black", \
#      file3  using 1:6 every 1 title "outlet"    with points pointtype 2 pointsize 0.5 linecolor rgbcolor "black"

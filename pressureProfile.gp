...
set   ylabel    "{/:Italic p}" offset 1.5,0.0,0.0
set format x "%.3f"
...
set   output   "pressure_profiles.svg"
unset key
set   key on
...
file1="postProcessing/pressureProfile/".myStep."/line.xy"
file2="postProcessing/pressureProfileInlet/".myStep."/line.xy"
file3="postProcessing/pressureProfileOutlet/".myStep."/line.xy"

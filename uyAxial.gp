...
set   ylabel    "{/:Italic u_y}" offset 1.5,0.0,0.0
set format x "%2.2f"
...
plot  file1  using 1:3 every 1 title "mesh10"     with points pointtype 7 pointsize 0.4 linecolor rgbcolor "black"

...
# EXECUTE USING;
# gnuplot -c velocityProfileComp.gp
#
...
#set   ylabel    "{/:Italic U}" offset 1.5,0.0,0.0
set   ylabel    "$V$" offset 1.0,0.0,0.0
set format x "%.1f"
set format y "%.2f"
...
set   output   "velocity_profiles_comp.svg"
unset key
set   key on
...
file0="velocity_profile_exact.dat"
file1="velocity_profile_mesh02.dat"
file2="velocity_profile_mesh04.dat"
file3="velocity_profile_mesh08.dat"

...
#set   xlabel    "$y$"
#set   ylabel    "$p_{rgh}$"
set   xlabel    "{/:Italic y}" offset 0.0,0.9,0.0
set   ylabel    "{/:Italic p_{rgh}}" offset 1.5,0.0,0.0
set format x "%2.2f"
...
file1="postProcessing/axialValues/".myStep."/line.xy"

plot  file1  using 1:5 every 1 title "mesh10"     with points pointtype 7 pointsize 0.4 linecolor rgbcolor "black"

#plot  file1  using 1:5 every 1 title "fully"     with lines dashtype 1 linewidth 2 linecolor rgbcolor "black", \
#      file2  using 1:5 every 1 title "inlet"     with points pointtype 7 pointsize 0.4 linecolor rgbcolor "black", \
#      file3  using 1:5 every 1 title "outlet"    with points pointtype 2 pointsize 0.5 linecolor rgbcolor "black"

...
# EXECUTE USING;
# gnuplot -c temperatureProfileComp.gp
#
# works with gnuplot 6.0
# gnuplot --help
# gnuplot -V ; # 2025: 6.0
...
set   xlabel    "$X$" offset 0.0,0.9,0.0
#set   ylabel    "{/:Italic {/Symbol q}}" offset 1.5,0.0,0.0
set   ylabel    "$\\theta$" offset 1.0,0.0,0.0
set format x "%.1f"
set format y "%.2f"
...
set   terminal svg size 600,400 noenhanced font "arial,16"
...
set   output   "temperature_profiles_comp.svg"
unset key
set   key on
...
file0="temperature_profile_exact.dat"
file1="temperature_profile_mesh02.dat"
file2="temperature_profile_mesh04.dat"
file3="temperature_profile_mesh08.dat"

plot  file0  using 1:2 every 1 title "Analytic"  with lines dashtype 1 linewidth 2 linecolor rgbcolor "black", \
      file1  using 1:2 every 1 title "Mesh02"    with points pointtype 7 pointsize 0.5 linecolor rgbcolor "black", \
      file2  using 1:2 every 1 title "Mesh04"    with points pointtype 2 pointsize 0.7 linecolor rgbcolor "black", \
      file3  using 1:2 every 1 title "Mesh08"    with points pointtype 6 pointsize 0.7 linecolor rgbcolor "black"
